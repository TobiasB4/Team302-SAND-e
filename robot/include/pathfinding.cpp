...
Autonomous::Map::Coordinates Autonomous::PathFinding::CalcPosition(Autonomous::Map::Coordinates source, long double range, long double bearing) {
    ...
    return Autonomous::Map::Coordinates(
...
void Autonomous::PathFinding::DrawMap(vector<Autonomous::Map::Coordinates> coordinateList, long double const INTERVAL_DIVISION, std::ofstream &file) {
    ...
    long double y_max = Autonomous::Map::Maximum(coordinateList);
    Autonomous::Map::Coordinates bottom = Autonomous::Map::Coordinates(coordinateList[0].latitude, y_min, 0);
    Autonomous::Map::Coordinates top = Autonomous::Map::Coordinates(coordinateList[0].latitude, y_max, 0);
    long double distance = Autonomous::PathFinding::CalcDistance(bottom, top);
    int intervals = distance / INTERVAL_DIVISION;
    // Change in y every subdivision
    long double dy = abs((y_max - y_min) / intervals);
    vector<Autonomous::Map::Lines> *line_equations = new vector<Autonomous::Map::Lines>{Autonomous::Map::Lines(coordinateList[0], coordinateList[coordinateList.size() - 1])};
